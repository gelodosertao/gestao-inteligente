...
const WhatsAppRedirect: React.FC = () => {
  useEffect(() => {
    // Dá um tempo de 1.5 a 2 segundos para o pixel/analytics registrar a visita
    const timer = setTimeout(() => {
      window.location.href = 'https://wa.me/5577998129383';
    }, 1500);
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center font-sans px-4 text-center">
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl flex flex-col items-center max-w-sm w-full border border-slate-100">
        ...
        <h2 className="text-2xl font-black text-slate-800 mb-2">Redirecionando...</h2>
        <p className="text-slate-500 mb-6 text-sm">Você está sendo levado para o nosso WhatsApp para falar com a equipe Gelo do Sertão.</p>
