...
const Financial: React.FC<FinancialProps> = ({ records, onAddRecord }) => {
  ...
  // Mock Tax Data
  const taxData = [
    { name: 'CPP (Previdência)', value: 450, color: '#3b82f6' },
    { name: 'ICMS', value: 380, color: '#f97316' },
    { name: 'ISS', value: 120, color: '#1e40af' },
    { name: 'PIS/COFINS', value: 210, color: '#f43f5e' },
  ];

  const totalTax = taxData.reduce((acc, curr) => acc + curr.value, 0);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="bg-emerald-500 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold mt-1">{formatCurrency(20000)}</h3>
            </div>
         ...
         <div className="bg-rose-500 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold mt-1">{formatCurrency(13700)}</h3>
            </div>
