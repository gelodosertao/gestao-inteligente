...
- [project] GitHub workflow: Issue → Branch → PR → Deploy (CONTRIBUTING.md). All agents must follow. → project-conventions.md
- [project] PRs must always reference Issues with `Closes #N` or `Refs #N` → project-conventions.md
